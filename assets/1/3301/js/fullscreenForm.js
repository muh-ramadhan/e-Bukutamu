;( function( window ) {
	...
	FForm.prototype._addControls = function() {
		...
		this.ctrlContinue = createElement( 'button', { cName : 'fs-continue', inner : 'Selanjutnya', appendTo : this.ctrls } );
		...
		var self = this,
			onEndAnimationFn = function( ev ) {
				...
				if( self.isLastStep ) {
					...
					// Menghapus Fungsi Overview classie.remove( self.formEl, 'fs-form-full' );
	...
	FForm.prototype._showError = function( err ) {
		...
		switch( err ) {
			case 'NOVAL' :
				message = 'Harap mengisi isian buku tamu sebelum menekan enter atau menekan tombol selanjutnya';
				break;
			case 'INVALIDEMAIL' :
				message = 'Pastikan untuk mengisi form yang telah ada';
				break;
			// ...
		};
